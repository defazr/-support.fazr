...
const FAQ_SECTIONS = [
    ...
    items: [
      {
        ...
        a: "현재 기준으로 소득 하위 70% 가구가 대상입니다. 건강보험료 납부액을 기준으로 선별되며, 4인 가구 기준 월 소득 약 974만원 이하가 해당됩니다. 다만 정책이 아직 확정되지 않아 기준은 변경될 수 있습니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "고유가 피해지원금 얼마 받나요?",
        a: "거주 지역에 따라 1인당 10만~25만원이 차등 지급됩니다. 수도권 10만원, 비수도권 15만원, 인구감소 우대지역 20만원, 특별지역 25만원입니다. 정확한 금액은 추경 확정 후 결정됩니다.",
      },
      {
        q: "고유가 피해지원금 언제 지급되나요?",
        a: "국회 추경안 통과 후 1차로 기초생활수급자·차상위계층에 우선 지급되고, 2차로 일반 대상자에게 지급될 예정입니다. 현재는 국회 심사 중이며 정확한 일정은 확정 시 업데이트됩니다.",
      },
      {
        q: "고유가 피해지원금 사용처 제한이 있나요?",
        a: "신용카드·체크카드 포인트 충전 또는 지역사랑상품권으로 지급될 예정입니다. 사용 기한이 설정될 가능성이 있으며, 미사용 잔액은 국고 환수될 수 있습니다.",
      },
    ],
  },
  {
