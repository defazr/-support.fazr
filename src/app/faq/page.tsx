...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      {
        q: "지금 바로 신청할 수 있나요?",
        a: '지원금 신청은 신청 기간별로 진행됩니다.<br /><br />신청 일정:<br />- 1차 신청 (취약계층): 4월 27일~5월 8일<br />- 2차 신청 (소득 하위 70%): 5월 18일~7월 3일<br />- 시스템 정비 기간: 5월 9일~17일<br /><br />2차 신청은 5월 18일(월) 09:00부터 시작되며, 첫 주에는 출생연도 끝자리 5부제가 적용됩니다. 5월 25일 이후에는 자격이 있는 모든 대상자가 신청할 수 있습니다.<br /><br />신청 가능 여부는 위 일정과 본인 자격 조건을 함께 확인하세요.<br /><br />국민비서 알림서비스(<a href="https://ips.go.kr" target="_blank" rel="noopener noreferrer" class="text-primary underline">ips.go.kr</a>)에서 신청 시작 전 안내를 받을 수 있습니다.',
      },
      {
